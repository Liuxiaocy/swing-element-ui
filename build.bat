...
echo --- AstTabsDemo self-check ---
"%JRUN%" -ea -cp out org.swelement.demo.AstTabsDemo --selfcheck
if %ERRORLEVEL% NEQ 0 ( echo AstTabsDemo self-check FAILED & exit /b 1 )

echo --- AstStepsDemo self-check ---
...
echo --- AstRadioDemo self-check ---
"%JRUN%" -ea -cp out org.swelement.demo.AstRadioDemo --selfcheck
if %ERRORLEVEL% NEQ 0 ( echo AstRadioDemo self-check FAILED & exit /b 1 )

echo --- AstCheckboxDemo self-check ---
...
echo --- AstCollapseDemo self-check ---
...
echo --- AstDatePickerDemo self-check ---
"%JRUN%" -ea -cp out org.swelement.demo.AstDatePickerDemo --selfcheck
if %ERRORLEVEL% NEQ 0 ( echo AstDatePickerDemo self-check FAILED & exit /b 1 )
